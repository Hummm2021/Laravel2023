      ...
      <div class="card ">
        <div class="card-body">
          ...
          <div class="mb-2 d-flex justify-content-center align-items-center">
            ...
            <a href="{{ route('user.delete-demande', $demande->id) }}" class="btn btn-outline-danger btn-icon btn-icon-start w-100 w-md-auto">
      ...
      <div class="modal modal-center fade" id="EditDemandeModal{{ $demande->id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{ route('user.update-demande', $demande->id) }}" method="POST" autocomplete="off">
              @csrf
  ...
  <div class="col-8 col-lg-4 mb-4">    
      <div class="d-flex justify-content-between">
        ...
        {{-- <button class="btn btn-icon btn-icon-end btn-xs btn-background-alternate p-0 text-small" type="button">
          <a href="{{ route('user.intervention') }}" class="align-bottom">Voir Plus</a>
  ...
  <div class="modal modal-center fade" id="EditInterventionModal{{ $intervention->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('user.update-intervention', $intervention->id) }}" method="POST" autocomplete="off">
          @csrf
          <div class="modal-body">
              <div class="mb-3">
              ...
              <div class="mb-3">
                <div class="text-small text-muted">STATUT</div>
                  ...
                  <span class="badge bg-outline-danger me-1">{{ $intervention->status }}</span>
                  @endif 
                  {{-- <select name="status" type="text" id="status" class="form-control" default="{{ $intervention->status }}"> --}}
