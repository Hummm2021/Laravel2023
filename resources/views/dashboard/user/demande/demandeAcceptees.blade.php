...
<div class="page-title-container mb-3">
  <div class="row">
    ...
    <div class="col mb-2">
      ...
      <h1 class="mb-2 pb-0 display-4" id="object">Vos Demandes en Acceptées</h1>
    </div>
    <!-- object End -->
...
@elseif(Auth::user()->profile == 'technicien')
<div class="page-title-container mb-3">
  <div class="row">
    <!-- object Start -->
    <div class="col mb-2">
      ...
      <h1 class="mb-2 pb-0 display-4" id="object">Demandes Acceptées</h1>
    </div>
    <!-- object End -->
