...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('template/css/vendor/OverlayScrollbars.min.css')}}" />
  ...
  <body class="h-100">
    ...
    <script src="{{asset('template/js/vendor/jquery-3.5.1.min.js')}}"></script>
    <script src="{{asset('template/js/vendor/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('template/js/vendor/OverlayScrollbars.min.js')}}"></script>
    <script src="{{asset('template/js/vendor/autoComplete.min.js')}}"></script>
    <script src="{{asset('template/js/vendor/clamp.min.js')}}"></script>

    <script src="{{asset('template/icon/acorn-icons.js')}}"></script>
    <script src="{{asset('template/icon/acorn-icons-interface.js')}}"></script>

    <script src="{{asset('template/js/vendor/jquery.validate/jquery.validate.min.js')}}"></script>

    <script src="{{asset('template/js/vendor/jquery.validate/additional-methods.min.js')}}"></script>

    <!-- Vendor Scripts End -->

    <!-- Template Base Scripts Start -->
    <script src="{{asset('template/js/base/helpers.js')}}"></script>
    <script src="{{asset('template/js/base/globals.js')}}"></script>
    <script src="{{asset('template/js/base/nav.js')}}"></script>
    <script src="{{asset('template/js/base/search.js')}}"></script>
    <script src="{{asset('template/js/base/settings.js')}}"></script>
    <!-- Template Base Scripts End -->
    <!-- Page Specific Scripts Start -->

    <script src="{{asset('template/js/pages/auth.login.js')}}"></script>
