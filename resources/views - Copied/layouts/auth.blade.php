...
<body class="animsition">
    <div class="" >
        <div class="page-content--bge5" style="display: flex; flex-direction: column; text-align: center;">
            <div class="container row" >
                <div class="login-wrap col-md-4">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#" style="background: #343a40; border: 5px solid #343a40; border-radius: 5%; box-shadow: 0 2px 4px rgba(0, 0, 0, .1), 0 8px 16px rgba(0, 0, 0, .1);">
